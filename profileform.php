...
<body>
    ...
    <form action ="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method ="POST">
        ...
        <div class="form-group">
            <label for="inputAddress">Class 10</label>
            <input type="text" class="form-control" name="Secondary" placeholder="Board percentage,  Name of board,      Year of Board,    School">
        </div>
        <div class="form-group">
            <label for="inputAddress2">Class 12</label>
            <input type="text" class="form-control" name="H_Secondary" placeholder="Board percentage,  Name of board,      Year of Board,    School">
        </div>
        <div class="form-group">
            <label for="inputAddress2">Other Qualifications</label>
            <input type="text" class="form-control"name ="O_qualification" placeholder="Other Qualifications">
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputCity">About</label>
                <input type="text" class="form-control"name="About" placeholder="Write something About Yourself">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                <label for="inputCity">Hobbies</label>
