...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#qualification">Educational Qualifications</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#Skills">Other Side of Me</a>
                    </li>
                    <li class="nav-item">
    ...
    <div id="qualification" class="container mt-3 mb-5">
        <div class="post-heading text-center">
            <h3 class="display-4 font-weight-bold">Educational Qualification</h3>
            <hr class="w-50 mx-auto pb-5">
        </div>

        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <h2>About Secondary Education</h2>
                <hr>
                <p><?php  echo $row['Secondary']   ?></p>
                <h2>About Higher Secondary Education</h2>
                <hr>
    ...
    <div id="Skills" class="container mt-3 mb-5">
        <div class="post-heading text-center">
            <h3 class="display-4 font-weight-bold">My Other Side</h3>
            <hr class="w-50 mx-auto pb-5">
        </div>
